...
const Contact = () => (
    ...
    <section className="contactos" id="contactos">
        ...
        <div className="icons">
            ...
            <a href="https://api.whatsapp.com/send?phone=XXXXXXXXXXXX" target="_blank" rel="noopener noreferrer" data-aos="zoom-in">
                <div className="layer">
                    <span></span>
                    <span></span>
                    <span></span>
            ...
            <a href="https://www.instagram.com/EmanKhalid/" target="_blank" rel="noopener noreferrer" data-aos="zoom-in">
                <div className="layer">
                    <span></span>
                    <span></span>
                    <span></span>
            ...
            <a href="https://www.linkedin.com/in/-eman-khalid/" target="_blank" rel="noopener noreferrer" data-aos="zoom-in">
                <div className="layer">
                    <span></span>
                    <span></span>
                    <span></span>
            ...
            <a href="https://github.com/techxexplorer" target="_blank" rel="noopener noreferrer" data-aos="zoom-in">
                <div className="layer">
                    <span></span>
                    <span></span>
                    <span></span>
