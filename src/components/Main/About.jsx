        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Eman Khalid and I am a full stack developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                ...
                <ul>
                    ...
                    <li>
                        <p><span>Email:</span> emankhalid01@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
            ...
            <div className="columns col-skill" data-aos="fade-left" data-aos-delay="650">
                ...
                <div className="skill">
                    ...
                    <div>
                        <img alt="Tailwind CSS" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-plain.svg" />
                        <h5>Tailwind CSS</h5>
                    </div>
                    <div>
